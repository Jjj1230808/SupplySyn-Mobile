<template>
	<view v-if="show2" class="mark">
		<view class="location-choose">
			...
			<text  style="transform: translateY(-30rpx);font-size: 38rpx;font-weight: 1000">物料撤回成功!</text>
			<view class="back-hometop"  >
				<span >您可以在<text style="font-weight: 1000 ;color: #000;" >开始装配</text>页面继续处理该物料</span>
			</view>
			<view class="back-home" @click="backHome()" >
				<span >返回列表</span>({{countdown}})
			</view>
