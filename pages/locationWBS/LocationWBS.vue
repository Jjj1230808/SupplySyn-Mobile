<template>
	...
	<view>
		<navbar style="position: fixed;left: 0;right: 0;top: 0;" title="请选择WBS" :isCanBack="true"
			>
		</navbar>
		...
		<scroll-view class="material-list">
			<location-choose :projectList="projectList" locationTitle="请选择WBS" :currentRoute1="currentRoute1" ></location-choose> 
		</scroll-view>
		<!-- <scroll-view class="material-list">
			<view class="">
				{{projectList}}
...
<script>
	...
	export default {
		...
		onLoad(options) {
			...
			let url = BaseApi + '/api/app/material/locating-the-wBS' ;
			let data ={
