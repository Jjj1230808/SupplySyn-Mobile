<template>
	...
	<view>
		<navbar style="position: fixed;left: 0;right: 0;top: 0;" title="请选择工位" :isCanBack="true"
			>
		</navbar>
		...
		<scroll-view class="material-list">
			<location-choose :projectList="projectList" locationTitle="请选择工位" :currentRoute1="currentRoute1"></location-choose> 
		</scroll-view>
		<!-- <scroll-view class="material-list">
			<view class="">
				{{projectList}}
