<template>
	...
	<view>
		<navbar style="position: fixed;left: 0;right: 0;top: 0;" title="物料退回" :isCanBack="true" text="ST03-80">
		</navbar>
			...
			<view class="material-item" v-for="item in 6">
				...
				<view class="material-action">
					...
					<button style="background-color: white;">
						<image style="width: 28rpx;height: 28rpx;" src="../../static/img/assignment_return.svg">
						</image>
						<view style="margin-right: 8rpx;color: #646464;font-size: 24rpx;">补打标签</view>
					</button>
				</view>
			</view>
...
<style lang="scss">
	...
	.material-action>view {
		...
		width: 156rpx;
		height: 50rpx;
		background-color: rgba(18, 155, 73, 0.20);
		padding: 0 12rpx;
		border-radius: 4rpx;
	}
