<template>
	...
	<view>
		<navbar style="position: fixed;left: 0;right: 0;top: 0;" title="报废单" :isCanBack="true" :text="stationNo">
		</navbar>
		...
		<scroll-view class="material-list">
			<view style="color: #646464;transform: translate(570rpx,-10rpx);"> {{"报废总数 &nbsp;&nbsp;"}} <span
					style="color: #ff9800;">{{topData}}</span></view>
			<material-list :materialList="materialList" @returnMaterial="returnMaterial" cardtitle="报废单">
			</material-list>
